<?php class MOIP_Transparente_Model_Email_Pending extends Mage_Core_Model_Email_Template
{
    ...
    public function sendEmail(Varien_Object $order, $moip_details = [])
    {
    ...
    public function sendPendingNotifyEmail($customerEmail, $customerName, $emailTemplateVariables = [], $storeId = null)
    {
