<?php class MOIP_Transparente_Model_Email_Cancel extends Mage_Core_Model_Email_Template
{
    const ENTITY = 'order';
    ...
    public function getLinkReorder($order)
    {
        ...
        if ($order->getCustomerIsGuest()) {
            return Mage::getUrl('sales/guest/reorder', ['order_id' => $order->getId()]);
        }

        return Mage::getUrl('sales/order/reorder', ['order_id' => $order->getId()]);
    }
    ...
    public function sendCancelOrderEmail($customerEmail, $customerName, $emailTemplateVariables = [], $storeId = null)
    {
