 ...
 */
class MOIP_Onestepcheckout_Block_Checkout_Address_Edit extends Mage_Directory_Block_Data
{
    protected $_address;
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->_address->getId()) {
            $this->_address->setPrefix($this->getCustomer()->getPrefix())
                ...
                ->setTaxvat($this->getCustomer()->getTaxvat())
                ->setDob($this->getCustomer()->getDob())
